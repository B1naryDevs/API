...
public class CandidatoTabela {
    ...
    public CandidatoTabela(){}

    public CandidatoTabela(String nome, Long cpf,String dataNac,String email,String senha,Long telefone,String expEmpresa,
    ...
    public CandidatoTabela(String nome, long telefone, long cpf){
        this.nome = nome;
        this.telefone = telefone;
        this.cpf = cpf;
    }
